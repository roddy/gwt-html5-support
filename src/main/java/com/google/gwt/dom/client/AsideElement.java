 ...
 * HTML5 aside element.
 *
 * @see <a href="http://www.w3.org/html/wg/drafts/html/master/sections.html#the-aside-element">W3C HTML5 Draft</a>
 */
@TagName(AsideElement.TAG)
public class AsideElement extends Element {
    public static final String TAG = "aside";

    /**
     * Assert that the given {@link Element} is compatible with this class and automatically typecast it.
     */
    public static AsideElement as(Element element) {
        assert is(element);
        return (AsideElement) element;
    }

    /**
     * Determines whether the given {@link com.google.gwt.core.client.JavaScriptObject} can be cast to this class. A
