...
/**
 * HTML4 small text element.
 *
 * @see <a href="http://www.w3.org/html/wg/drafts/html/master/sections.html#the-small-element">W3C HTML5 Draft</a>
 */
@TagName(SmallElement.TAG)
public class SmallElement extends Element {
     ...
     */
    public static SmallElement as(Element element) {
        assert is(element);
        return (SmallElement) element;
    }
    ...
    /**
     * Determines whether the given {@link com.google.gwt.dom.client.Node} can be cast to this class. A <code>null</code> object will cause this
